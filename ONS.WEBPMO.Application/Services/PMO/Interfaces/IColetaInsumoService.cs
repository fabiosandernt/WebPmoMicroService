...
namespace ONS.WEBPMO.Application.Services.PMO.Interfaces
{
    ...
    public interface IColetaInsumoService
    {
        ...
        ICollection<ColetaInsumo> ConsultarColetasInsumoParaInformarDadosPaginado(PesquisaMonitorarColetaInsumoFilter filter);


        //[UseNetDataContractSerializer("Situacao", "Insumo", "Agente")]
        ICollection<ColetaInsumo> ConsultarColetasInsumoParaMonitorarDadosPaginado(
        ...
        ICollection<DadoColetaManutencaoDTO> ConsultarDadoColetaManutencaoPorColetaInsumoPaginado(DadoColetaInsumoFilter filter);
